...
func CreateUser(db *sql.DB, user *models.User) error {
	_, err := db.Exec(`INSERT INTO users (username, password, email, profile_picture) VALUES (?, ?, ?, ?)`,
		user.Username, user.Password, user.Email, user.ProfilePicture)
	return err
}
...
func GetUserByID(db *sql.DB, id int) (*models.User, error) {
	...
	if profilePicture.Valid {
		profile_pic := &profilePicture.String
